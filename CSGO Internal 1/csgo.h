...
constexpr ptrdiff_t dwSensitivity = 0xDCE8F4;
constexpr ptrdiff_t dwSensitivityPtr = 0xDCE8C8;
...
constexpr ptrdiff_t dwYawPtr = 0xCD5A0002;
...
constexpr ptrdiff_t find_hud_element = 0x32D250F0;
